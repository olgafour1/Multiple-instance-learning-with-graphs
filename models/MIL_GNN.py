...
class GraphBased32x32x3(nn.Module):
    def __init__(self):
    ...
    def calculate_objective(self, X, target):
        ...
        neg_log_likelihood = -1. * (
                    target * torch.log(Y_prob) + (1. - target) * torch.log(1. - Y_prob))  # negative log bernoulli
